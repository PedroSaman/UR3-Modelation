function [J] = Jacobian()
% Calculates the symbolic Geometric Jacobian for the UR3 robot, defined in
% the dh matrix below.
t = sym('t',[6 1],'real');
...
J = simplify([cross(z0,P-p0),cross(z1,P-p1),cross(z2,P-p2),cross(z3,P-p3),cross(z4,P-p4),cross(z5,P-p5);z0,z1,z2,z3,z4,z5]);
%After analytical analysis I found that theta5 = n*pi or theta3 = n*pi are
%inflection points
%O determinante dessa Jocb é zero quando theta5 = n*pi ou theta3 = n*pi
end