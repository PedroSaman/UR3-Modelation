function [q,d_q,d_d_q,m_torque,time,omega,d_omega,alpha] = Data_Preparation(filepath)
    ...
    load (filepath);
    %exemple: '~/Documents/Git/UR3-Modelation/MAT files/Id_data_total.mat'
    ...
    m_torque = [torque_J1 torque_J2 torque_J3 torque_J4 torque_J5 torque_J6]; 
