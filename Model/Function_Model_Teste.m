function [Tau] = Function_Model_Teste(theta,q,omega,d_omega,alpha,f7,t7,torque)
    ...
    %First value for Tau aproximation
    Tau = 0;
    ...
    for i=length(torque)-1
        ...
        omega1 = omega(1:3,i);
        alpha1 = alpha(1:3,i);
        a_c1 = cross(d_omega(1:3,i),r0_1) + cross(omega1,cross(omega1,r0_1));
        a_e1 = cross(d_omega(1:3,i),r0_c1) + cross(omega1,cross(omega1,r0_c1));

        %Link2
        omega2 = omega(4:6,i);
        alpha2 = alpha(4:6,i);
        a_c2 = R1_2'*a_e1 + cross(d_omega(4:6,i),r1_2) + cross(omega2,cross(omega2,r1_2));
        a_e2 = R1_2'*a_e1 + cross(d_omega(4:6,i),r1_c2) + cross(omega2,cross(omega2,r1_c2));

        %Link3
        omega3 = omega(7:9,i);
        alpha3 = alpha(7:9,i);
        a_c3 = R2_3'*a_e2 + cross(d_omega(7:9,i),r2_3) + cross(omega3,cross(omega3,r2_3));
        a_e3 = R2_3'*a_e2 + cross(d_omega(7:9,i),r2_c3) + cross(omega3,cross(omega3,r2_c3));    

        %Link4
        omega4 = omega(10:12,i);
        alpha4 = alpha(10:12,i);
        a_c4 = R3_4'*a_e3 + cross(d_omega(10:12,i),r3_4) + cross(omega4,cross(omega4,r3_4));
        a_e4 = R3_4'*a_e3 + cross(d_omega(10:12,i),r3_c4) + cross(omega4,cross(omega4,r3_c4));

        %Link5
        omega5 = omega(13:15,i);
        alpha5 = alpha(13:15,i);
        a_c5 = R4_5'*a_e4 + cross(d_omega(13:15,i),r4_5) + cross(omega5,cross(omega5,r4_5));
        a_e5 = R4_5'*a_e4 + cross(d_omega(13:15,i),r4_c5) + cross(omega5,cross(omega5,r4_c5));

        %Link6
        omega6 = omega(16:18,i);
        alpha6 = alpha(16:18,i);
        a_c6 = R5_6'*a_e5 + cross(d_omega(16:18,i),r5_6) + cross(omega6,cross(omega6,r5_6));
